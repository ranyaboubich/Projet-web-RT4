...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3045927768ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=book">`projectbackend1`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=waiting_list">`projectbackend1`.`waiting_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=reservation">`projectbackend1`.`reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=user">`projectbackend1`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=panier">`picasoie2`.`panier`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=commande">`picasoie2`.`commande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=tableau">`picasoie2`.`tableau`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=client">`picasoie2`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=avis">`picasoie2`.`avis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=categorie">`picasoie2`.`categorie`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6b697a3d5032432b7233363147633b56">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="projectbackend1" targettable="book">
            ...
            Queried time
                            ...
                            <span class="query">insert into MOCK_DATA (id, title, category, author, keywords, instances, coverImageUrl, description) values (49, &#039;Where Is Fred!? (Wo ist Fred?)&#039;, &#039;Comedy|Romance&#039;, &#039;Moll Naerup&#039;, &#039;Intuitive&#039;, 2, &#039;http://dummyimage.com/231x100.png/5fa2dd/ffffff&#039;, &#039;Myocarditis in diseases classified elsewhere&#039;);insert into MOCK_DATA (id, title, category, author, keywords, instances, coverImageUrl, description) values (50, &#039;Pink Panther, The&#039;, &#039;Comedy|Crime&#039;, &#039;Kin McKillop&#039;, &#039;Advanced&#039;, 2, &#039;http://dummyimage.com/210x100.png/5fa2dd/ffffff&#039;, &#039;Laceration of heart, unspecified with or without hemopericardium, sequela&#039;);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `book`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projectbackend1" targettable="book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">insert into books (id, title, author, category, keywords, description, instances) values (1, &#039;To Kill a Mockingbird&#039;, &#039;Mia Thompson&#039;, &#039;Adventure|Fantasy|Romance&#039;, &#039;art&#039;, &#039;Acute hematogenous osteomyelitis&#039;, 2);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="projectbackend1" targettable="book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">insert into book (id, title, author, category, keywords, description, instances) values (4, &#039;The Hobbit&#039;, &#039;James Martinez&#039;, &#039;Drama&#039;, &#039;history&#039;, &#039;Infective myositis, right shoulder&#039;, 2);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projectbackend1" targettable="book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">insert into book (id, title, author, category, keywords, description, instances) values (20, &#039;The Odyssey&#039;, &#039;John Smith&#039;, &#039;Comedy|Horror|Mystery|Sci-Fi&#039;, &#039;cookbooks&#039;, &#039;Toxic effect of corrosive alkalis and alkali-like substances, intentional self-harm, subsequent encounter&#039;, 6);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="projectbackend1" targettable="book">
                            <div class="action_content">
