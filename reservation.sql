...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=reservation">`projectbackend1`.`reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=book">`projectbackend1`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=waiting_list">`projectbackend1`.`waiting_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projectbackend1&table=user">`projectbackend1`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=panier">`picasoie2`.`panier`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=commande">`picasoie2`.`commande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=tableau">`picasoie2`.`tableau`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=client">`picasoie2`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=avis">`picasoie2`.`avis`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=picasoie2&table=categorie">`picasoie2`.`categorie`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
    ...
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `book`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="projectbackend1" targettable="reservation">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
